...
public:
    ...
    virtual Separator* createSeparator(Layouting::Anchor *anchor, QWidgetAdapter *parent = nullptr) const = 0;
...
public:
    ...
    Separator *createSeparator(Layouting::Anchor *anchor, QWidgetAdapter *parent = nullptr) const override;
